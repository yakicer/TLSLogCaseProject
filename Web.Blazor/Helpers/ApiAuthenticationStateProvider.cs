...
namespace Web.Blazor.Helpers
{
    public class ApiAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        {
            var savedToken = await _localStorage.GetItemAsync("Auth-Token");
        ...
        {
            var authenticatedUser = new ClaimsPrincipal(new ClaimsIdentity(new[] { new Claim(ClaimTypes.Name, email) }, "Auth-Token"));
